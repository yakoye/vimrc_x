...
# username = test
alias v='/home/test/vimrc_x/scripts/dealstr_vim.sh'
alias g='/home/test/vimrc_x/scripts/dealstr_gvim.sh'
alias vscode='/snap/bin/code'

alias mp='screen /home/test/tools/os/p95v298b6/mprime &'
alias s='screen'

alias vb='vim ~/.bashrc'
alias sb='source ~/.bashrc && echo Bash config reloaded'
alias eclipse='/home/test/tools/os/eclipse/eclipse &'
alias bc='/home/test/vimrc_x/scripts/bcompare_run.sh &'
alias bcompare='/bin/rm -rf /home/test/.config/bcompare/registry.dat; /usr/bin/bcompare '
alias rm='/home/test/vimrc_x/scripts/rm_file.sh'
alias rmrm='/bin/rm'

alias astyle='astyle -A1 -s4 -S -N -j -m0 -M40 -c -U -H -p -n -q '
alias gencsfile='find /usr/include `pwd` -name "*.[ch]" -o -name "*.cpp" > cscope.files'
# tag generate
...
alias backupfile='/home/test/code/backupfile.sh'
