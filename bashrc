...
alias v='/home/color/scripts/dealstr_vim.sh'
alias g='/home/color/scripts/dealstr_gvim.sh'
alias vscode='/snap/bin/code'

alias mp='screen /home/color/tools/os/p95v298b6/mprime &'
alias s='screen'

alias vb='vim ~/.bashrc'
alias sb='source ~/.bashrc && echo Bash config reloaded'
alias eclipse='/home/color/tools/os/eclipse/eclipse &'
alias bc='/home/color/scripts/bcompare_run.sh &'
alias bcompare='/bin/rm -rf /home/color/.config/bcompare/registry.dat; /usr/bin/bcompare '
alias rm='/home/color/scripts/rm_file.sh'
alias rmrm='/bin/rm'
...
alias backupfile='/home/color/code/backupfile.sh'
