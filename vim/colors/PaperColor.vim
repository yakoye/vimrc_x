...
fun! s:apply_syntax_highlightings()
  ...
  " Functions
  " see => .vim/after/syntax/c.vim
  "exec 'hi cFunction guifg=SteelBlue1 cterm=bold  ctermfg=blue'
  ...
  "exec 'hi cFunctionmy gui=NONE cterm=bold  ctermfg=blue'
  "exec 'hi cFunctionmy guifg=CornflowerBlue cterm=bold  ctermfg=blue'
  "exec 'hi cFunctionmy guifg=DeepSkyBlue2 cterm=bold  ctermfg=blue'
